...
from aeroflux.schemas.types import STRUCTURAL_OUTPUT_SPEC, StructuralOutput
from aeroflux.schemas.validation import validate_discipline_output
from aeroflux.structures.beam import (
...
from aeroflux.structures.mass import estimate_oew, wing_structural_mass
...
class StructuralDiscipline(DisciplineBase):
    def __call__(self, **inputs: Any) -> Any:
        ...
        tc_stations = np.array([
            sec.thickness_at(np.array([0.35]))[0] for sec in wing.airfoil_sections
        ])
